...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_D5GDj1qD.mjs'
    ).then(n => n.K).catch((e) => {
...
}, "/home/user/pircasdequilapilun/node_modules/astro/components/Image.astro", void 0);
...
}, "/home/user/pircasdequilapilun/node_modules/astro/components/Picture.astro", void 0);
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[],"endpoint":"astro/assets/endpoint/node"};
					...
					const outDir = /* #__PURE__ */ new URL("file:///home/user/pircasdequilapilun/dist/client/");
